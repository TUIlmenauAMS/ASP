#This is a library that implements a MDCT filter bank, including a realt time implelentation.
...
#        python MDCT_realtime_synthesis.py mixed_mdct_y.bin mixed_rek.wav
