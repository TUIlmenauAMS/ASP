#This is a library that implements a QMF filter bank, including a real time implelentation.
#It also includes a sine modulated QMF filter bank.
...
def DSToMatrix(N):
	#produces an odd DST matrix with size NxN
	#Gerald Schuller, Jan. 2016
...
def qmfrt_example():
	...
	"""
	xtest=np.arange(N);
        ytest1=np.dot(xtest,DSToMatrix(N))
	print "output with DSTo:", ytest1
	ytest2=DST4(xtest)
	print "output with DST4:", ytest2
 	"""
